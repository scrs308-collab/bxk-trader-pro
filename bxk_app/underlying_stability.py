...
def calculate_underlying_stability_metrics(
    *,
    symbol,
    underlying_price,
    expected_move,
    ...
    """
    Calculate generic iron-condor stability measurements.

    This is observation-only.

    Stability becomes signal-ready only when:
      - regular market status is LIVE
      - expected move comes from the option chain
    ...
    return {
        ...
        "implied_move":
            round(implied_move, 2),

        "session_range":
            round(session_range, 2),

...
def build_demo_trade(spx_price=7535.54, expected_move=62.5, wing_width=25):
    ...
    return {
        ...
        "best_trade": {
            ...
            "risk_reward": round(max_risk / (credit * 100), 2),
...
def build_best_trade(
    ...
    for candidate in raw_candidates:
        ...
        credit = (
            credit_data.get("live_credit")
            or credit_data.get("credit")
            or 0
        )
        ...
        put_distance = round(float(spx_price) - sell_put, 2)
        call_distance = round(sell_call - float(spx_price), 2)
